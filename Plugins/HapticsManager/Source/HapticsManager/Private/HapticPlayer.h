...
public:
	...
	void RegisterFeedback(FString Key, FString ProjectJson);
	void SubmitRegistered(FString Key);
	void SubmitRegistered(FString Key, FString AltKey, FScaleOption ScaleOpt, FRotationOption RotOption);
