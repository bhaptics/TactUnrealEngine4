...
FTactosyFileActions::FTactosyFileActions(const TSharedRef<FSlateStyleSet>& InStyle)
	: Style(InStyle)
{
}

uint32 FTactosyFileActions::GetCategories()
{
	return EAssetTypeCategories::None;
}

FText FTactosyFileActions::GetName() const
{
...
void FTactosyFileActions::GetActions(const TArray<UObject*>& InObjects, FMenuBuilder & MenuBuilder)
{
...
bool FTactosyFileActions::HasActions(const TArray<UObject*>& InObjects) const
{
	return false;
}
