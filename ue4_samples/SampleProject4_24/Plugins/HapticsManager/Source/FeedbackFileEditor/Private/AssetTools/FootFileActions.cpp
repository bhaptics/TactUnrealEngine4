...
FFootFileActions::FFootFileActions(const TSharedRef<FSlateStyleSet>& InStyle)
	: Style(InStyle)
{
}

uint32 FFootFileActions::GetCategories()
{
	return EAssetTypeCategories::None;
}

FText FFootFileActions::GetName() const
{
...
FColor FFootFileActions::GetTypeColor() const
{
	return FColor::Yellow;
}

bool FFootFileActions::CanFilter()
{
	return true;
}

void FFootFileActions::GetActions(const TArray<UObject*>& InObjects, FMenuBuilder & MenuBuilder)
{
...
bool FFootFileActions::HasActions(const TArray<UObject*>& InObjects) const
{
	return false;
}
