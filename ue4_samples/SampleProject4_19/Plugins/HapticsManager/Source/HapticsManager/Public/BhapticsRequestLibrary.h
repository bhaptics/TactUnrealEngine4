...
public:
	...
	UFUNCTION(BlueprintPure,
		meta = (DisplayName = "TTTTTTTTTTTTTTT Get Angle",
			Keywords = "bHaptics"),
		Category = "bHaptics")
		static float GetAngle(FVector ContactLocation, FVector PlayerLocation, FVector PlayerForward);

	UFUNCTION(BlueprintPure,
		meta = (DisplayName = "TTTTTTTTTTTTTTT Get Angle",
			Keywords = "bHaptics"),
		Category = "bHaptics")
		static float GetAngleHitNormal(FVector HitNormal, FVector PlayerForward);
};
